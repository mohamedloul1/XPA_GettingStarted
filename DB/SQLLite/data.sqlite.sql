...
CREATE TABLE IF NOT EXISTS "BCK002" (
	"contact_id"	INT,
	"email"	TEXT,
	"mobielnummer"	INT,
	"fax"	INT
...
CREATE TABLE IF NOT EXISTS "BCK001" (
	"person_id"	INT,
	...
	CONSTRAINT "FKY001BCK001" FOREIGN KEY("person_id") REFERENCES "contact"("contact_id")
);
CREATE TABLE IF NOT EXISTS "BCK008" (
	"aantal_voorraad"	TEXT,
	"aantal_ijzeren_voorraad"	TEXT
);
...
CREATE TABLE IF NOT EXISTS "BCK010" (
	"artikel_id"	INT,
...
CREATE TABLE IF NOT EXISTS "BCK003" (
...
INSERT INTO "BCK002" VALUES (1,'example@gmail.com',686464658,'+31-686464658');
...
INSERT INTO "BCK001" VALUES (1,'Mohammed','Schipholplein',215,'','6843BR','','Man','','');
INSERT INTO "BCK001" VALUES (2,'John Doe','straat1',1250,'','6666KH','','Man','','');
...
INSERT INTO "BCK003" VALUES ('DE','Germany','Europa
','+49',1,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO "BCK003" VALUES ('MA','Morocco','Noord-Africa
','+212',2,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO "BCK003" VALUES ('JP','Japan','Oost-Azie','+81',3,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO "BCK003" VALUES ('TR','Turkije','Midden-Oostena	','+90',1,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO "BCK003" VALUES ('JP','Japan',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO "BCK003" VALUES ('SP','Spain','Europa
','+34',1,NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO "BCK003" VALUES ('JP','Japa',NULL,NULL,NULL,'2020-12-22','20:54:11','SUPERVISOR','2020-12-22','20:54:05','SUPERVISOR');
INSERT INTO "BCK003" VALUES ('ua','ua',NULL,NULL,NULL,'2020-12-22','20:54:02','SUPERVISOR',NULL,NULL,NULL);
INSERT INTO "BCK003" VALUES ('VA','UAE',NULL,NULL,NULL,'2020-12-23','16:12:54','','2020-12-23','16:12:45','');
...
CREATE UNIQUE INDEX IF NOT EXISTS "KEY001BCK002" ON "BCK002" (
	"contact_id"
);
CREATE UNIQUE INDEX IF NOT EXISTS "KEY001BCK001" ON "BCK001" (
	"person_id"
);
CREATE INDEX IF NOT EXISTS "land_id" ON "WarningCode" (
	"code_id"
);
CREATE UNIQUE INDEX IF NOT EXISTS "KEY001BCK010" ON "BCK010" (
	"artikel_id"
);
COMMIT;
